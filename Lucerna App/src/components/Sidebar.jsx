...
const navSections = [
  ...
  },
  {
    label: "Analyze",
    items: [
      { label: "Campaigns", path: "/campaigns", icon: IF("M3 4a1 1 0 011-1h12a1 1 0 011 1v2H3V4zm0 4h14v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm3 2a1 1 0 100 2h2a1 1 0 100-2H6z") },
